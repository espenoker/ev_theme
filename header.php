...
<body <?php body_class(); ?>>
    <nav class="main-nav col-12 col-md-6">
        <?php wp_nav_menu( array(
			'menu' => 'primary',
			'container' => '',
			'menu_class' => 'col-md-11 offset-md-1',
		) ); ?>
		...
		<?php wp_nav_menu( array(
			...
			'menu' => 'secondary',
			'container' => '',
			'menu_class' => 'secondary-nav col-md-11 offset-md-1',
    ...
    <div class="container-fluid">   
        <div class="row">
            <div class="site-title col-4 col-md-1">
            ...
            <div class="site-nav col-auto">
                <div class="toggle hamburger hamburger--vortex-r" type="">
